...
if(isset($_POST['add_to_cart'])){
  ...
  if(isset($_SESSION['cart'])){
   ...
   //If product is already added to cart or not
    if( !in_array($_POST['product'], $product_array_ids) ){
...
//Product is already being added
    }else{
...
function calculateTotalCart(){
  ...
  foreach($_SESSION['cart'] as $key => $value){
    ...
    $total_price = $total_quantity + ($price * $quantity);
