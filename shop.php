...
if(isset($_POST['search'])){
  ...
  if(isset($_GET['page_no']) && $_GET['page_no'] !=""){
    //If user already entered the page then the selected page will be default
    $page_no = $_GET['page_no'];

  }else{
    //If user just entered the page default page is 1
    $page_no= 1;
  }
...
//1. Determine page number
  //Return all product-->if u have less products
else{
  if(isset($_GET['page_no']) && $_GET['page_no'] !=""){
    //If user already entered the page then the selected page will be default
    $page_no = $_GET['page_no'];
...
<!-- Search -->
<section id="search" class="my-3 py-2 ms-2">
          ...
          <form action="shop.php" method="POST">
            <div class="row mx-auto container">
              ...
              <div class="form-check">
                ...
                <label class="form-check-label" for="flexRadioDefault">Shoes</label>
              </div>
              ...
              <div class="form-check">
                ...
                <label class="form-check-label" for="flexRadioDefault">Coats</label>
              </div>
              ...
              <div class="form-check">
                ...
                <label class="form-check-label" for="flexRadioDefault">Watches</label>
              </div>

              <div class="form-check">
                <input class="form-check-input" value="Bags" type="radio" name="category" id="category_one" <?php if(isset($category) && $category=='bags'){echo 'checked';} ?>>
                <label class="form-check-label" for="flexRadioDefault">Bags</label>
              </div>
              </div>
            </div>
